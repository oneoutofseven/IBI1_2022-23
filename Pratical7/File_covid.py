...
os.chdir("C:/users/xuchenzhi/IBI1_2022-23/IBI1_2022-23/Pratical7")
...
df1=df.loc[df.location != "World",:] #exclude the "World"
newcases = df1.loc[df1.date=="2020-03-31","new_cases"] #make a dataframe of the new cases on 2020-03-31
newdeaths = df1.loc[df1.date=="2020-03-31","new_deaths"] #make a dataframe of the new deaths on 2020-03-31
print (newcases)
...
world_data= df1.loc[df1.date=="2020-03-31",["new_cases","new_deaths"]]
print (world_data)
